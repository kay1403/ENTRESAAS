...
echo -e "${BLUE}════════════════════════════════════════════════════════════════${NC}"
echo -e "${BLUE}  TEST SPÉCIFIQUE CRÉATION DE RÔLE (CORRIGÉ)${NC}"
echo -e "${BLUE}════════════════════════════════════════════════════════════════${NC}\n"
...
# Test 1: Création rôle avec permissionIds vide (devrait réussir maintenant)
...
# Test 2: Création rôle avec description seulement
